"""
Django settings for MyTraveler project.
...
SECRET_KEY = '%=fyxx!3#rgrx^3&i_hbc_btp2d4h*0eor_jk)hax9k_r&*7&d'
...
WSGI_APPLICATION = 'MyTraveler.wsgi.application'
